# Generated by Django 4.0 on 2022-06-22 14:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wishlist', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='api.wishlist')),
            ],
            options={
                'ordering': ['-updated'],
            },
